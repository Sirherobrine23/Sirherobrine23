          ...
          <ul>{navBarItens.map((compo, index) => {
            return <li key={index}>
              <Link style={{
                display: "flex",
                alignItems: "center"
              }} href={compo.url||"#"} rel="https://sirherobrine23.org" target="_blank">{compo.name}&nbsp;{compo.svg}</Link>
            </li>;
          })}</ul>
        </div>
      </nav>
